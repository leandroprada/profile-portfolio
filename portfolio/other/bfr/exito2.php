...
<div class="">
	<button type="button" class="btn" style="background-color:rgba(156, 39, 176, 1)"><a href="form.php" style="text-decoration:none">Cargar Otro Amamantamiento</a></button>
