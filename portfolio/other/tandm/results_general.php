...
$result = mysqli_query($con,'SELECT * FROM registros');
  ...
  $result = mysqli_query($con,'SELECT * from registros where idioma_que_hablo = '.$langUserSpeaks.' AND idioma_a_practicar= '.$langUserLearns);
}?>
<div class="row">
...
<span class="">
  <a href="results_general_invertir.php"><button type="button" class="btn btnposts" name="button">Invertir Pares Lingüísticos</button></a></span>
