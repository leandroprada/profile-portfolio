...
$result = mysqli_query($con,'SELECT * from registros where idioma_que_hablo = '.$langUserLearns.' AND idioma_a_practicar= '.$langUserSpeaks."");
...
<div class="table-responsive">
   ...
   <thead>
   <tr>
<h3>Estan son Las últimas publicaciones
...
<tr>
  <span>Pares de Idiomas: <?php echo $usuarioLogueado->getAprendeIdioma()." - ".$usuarioLogueado->getHablaIdioma()
; ?></span>
<span class="">
  <a href="results_general.php"><button type="button" class="btn btnposts" name="button">Invertir Pares Lingüísticos</button></a></span>
  </tr>
  <tr>
  ...
  while($row = mysqli_fetch_array($result))
   ...
   <tr>
     ...
     <td>
  <?php $registro = $repoUsuarios->traerUsuarioPorEmail($row['correoElectronico']);

  echo $registro->getNombre()." ".$registro->getApellido()  ; ?>
  </td>
